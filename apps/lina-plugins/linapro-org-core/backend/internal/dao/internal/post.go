...
// PostColumns defines and stores column names for the table plugin_linapro_org_core_post.
...
// postColumns holds the columns for the table plugin_linapro_org_core_post.
...
func NewPostDao(handlers ...gdb.ModelHandler) *PostDao {
	return &PostDao{
		group:    "default",
		table:    "plugin_linapro_org_core_post",
		columns:  postColumns,
		handlers: handlers,
	}
}

// This file defines shared department response DTOs for the linapro-org-core API.
package v1

// DeptItem exposes department fields visible through linapro-org-core APIs.

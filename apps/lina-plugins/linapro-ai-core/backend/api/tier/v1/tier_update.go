...
type UpdateReq struct {
	g.Meta           `path:"/ai/tiers/{code}" method:"put" tags:"Smart Center/Tier Management" summary:"Update AI capability tier" dc:"Update one AI capability tier within a capability method, including enabled state, default thinking effort, and primary provider-model binding." permission:"ai:tier:update"`

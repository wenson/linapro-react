...
type ListReq struct {
	g.Meta           `path:"/ai/tiers" method:"get" tags:"Smart Center/Tier Management" summary:"List AI capability tiers" dc:"Return the fixed basic, standard, and advanced AI tiers for one capability method with their primary binding projection and latest test summary." permission:"ai:tier:list"`

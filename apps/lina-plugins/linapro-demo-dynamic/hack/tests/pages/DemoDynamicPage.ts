...
export class DemoDynamicPage extends PluginPage {
  private readonly hostedFrame: FrameLocator;

  constructor(page: Page) {
    super(page);
    this.hostedFrame = page.frameLocator("iframe.hosted-plugin-frame");
  }

  pluginHostedFrame(): FrameLocator {
    return this.hostedFrame;
  }

  pluginDemoDynamicTitle(): Locator {
    return this.hostedFrame.getByTestId("linapro-demo-dynamic-title").first();
  }

  pluginDemoDynamicDescription(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-description")
      .first();
  }

  pluginDemoDynamicOpenStandaloneButton(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-open-standalone")
      .first();
  }

  pluginDemoDynamicRecordGrid(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-record-grid")
      .first();
  }

  pluginDemoDynamicRecordAddButton(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-record-add")
      .first();
  }

  pluginDemoDynamicManifestDemo(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-manifest-demo")
      .first();
  }
  ...
  pluginDemoDynamicPaginationPrevButton(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-pagination-prev")
      .first();
  }

  pluginDemoDynamicPaginationNextButton(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-pagination-next")
      .first();
  }

  pluginDemoDynamicRecordModal(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-record-modal")
      .last();
  }
  ...
  pluginDemoDynamicRecordSubmitButton(): Locator {
    return this.hostedFrame
      .getByTestId("linapro-demo-dynamic-record-submit")
      .last();
  }
  ...
  pluginDemoDynamicEditButton(title: string): Locator {
    return this.pluginDemoDynamicRecordRow(title)
      .getByRole("button", { name: /编辑|Edit/u })
      .first();
  }

  pluginDemoDynamicDeleteButton(title: string): Locator {
    return this.pluginDemoDynamicRecordRow(title)
      .getByRole("button", { name: /删除|Delete/u })
      .first();
  }

...
// and cleanup services for the linapro-monitor-server source plugin. It owns the
// plugin_linapro_monitor_server table and runtime sampling logic instead of depending
...
import (
	...
	entitymodel "lina-plugin-linapro-monitor-server/backend/internal/model/entity"
)
...
// serverMonitorRecord reuses the plugin-local generated plugin_linapro_monitor_server entity.

...
func configureMembershipTestDB(t *testing.T, ctx context.Context) {
	...
	if err := gdb.SetConfig(gdb.Config{
		gdb.DefaultGroupName: gdb.ConfigGroup{{Link: membershipTestDatabaseLink()}},
	}); err != nil {
...
// membershipTestDatabaseLink allows the repository test workflow to select
// its PostgreSQL fixture while preserving the historical local default.
func membershipTestDatabaseLink() string {

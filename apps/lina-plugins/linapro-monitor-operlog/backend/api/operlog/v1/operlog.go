// This file defines shared operation-log response DTOs for the linapro-monitor-operlog API.
package v1

import "lina-plugin-linapro-monitor-operlog/backend/internal/model/operlogtype"
